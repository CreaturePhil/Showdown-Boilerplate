...
const shop = [
	...
	['XY-Ancient Flames', 'Get three cards from the Ancient Flames pack released in the Pokemon XY set.', 10],
];
...
exports.commands = {
	...
	buypack: function (target, room, user) {
		...
		if (packId !== 'xybase' && packId !== 'xyfuriousfists' && packId !== 'xyflashfire' && packId !== 'xyphantomforces' && packId !== 'xyroaringskies' && packId !== 'xyancientorigins') return self.sendReply("This pack is not currently in circulation.  Please use /packshop to see the current packs.");
